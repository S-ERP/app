        ...
        return <View style={{
            ...
            <SView col={"xs-12"} flex>
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <Page label={"Empresa"} icon={<ImagePage key_page="9b80fd4e-855c-430d-ad17-64449065eb3e" />} >
                    ...
                    >
                        ...
                        <Page label={"Centros de costos"} url={"/conta/centro_costo2"} permiso_url="/conta/cuentas" permiso="ver" />
                    ...
                    <Page label={"Inventario"}
                        ...
                        <Page label={"Reducción de inventario"} url={"/productos/reduccion_inventario"} permiso="ver" permiso_url="/productos/reduccion_inventario" />
                    ...
                    <Page label={"Caja"} url={"/caja"} permiso="ver" icon={<ImagePage key_page="a65b7814-6bfe-4604-8c91-5d955df5614b" />} decoradores={<CajaActiva />} />
                    ...
                    <Page label={"Ventas"} icon={<ImagePage key_page="8becb109-9987-4520-840d-7f0efdb6e3c6" />} >
                        ...
                        <Page label={"Ventas - Productos"} url={"/venta/tabla_productos"} permiso="ver" permiso_url="/venta" />
                        ...
                        <Page label={"Ventas Grupales"} url={"/venta/grupal"} permiso="ver" permiso_url="/venta" />
                    </Page>

                    <Page label={"Facturacion"} icon={<ImagePage key_page="a122ab1e-bf18-4831-8136-befa06e406d3" />} >
                    ...
                    <Page label={"CRM"} icon={<ImagePage key_page="9b5de113-c6e9-4bef-b686-5732056f71fb" />} >
                    ...
                    >
                        ...
                        <Page label={"Cajas"} url={"/dashboard/cajas"} permiso="ver" icon={<SIconApp name="iconLista" fill={STheme.color.text} />} />
                        <Page label={"Traspasos"} url={"/dashboard/traspasos"} permiso="ver" icon={<SIconApp name="iconLista" fill={STheme.color.text} />} />
