...
const STYLES = {
  ...
  text: { fontSize: 12, fontFamily: 'Courier', color: '#000' }, // Monoespaciada para recibos térmicos
  bold: { fontWeight: 'bold' },
  center: { textAlign: 'center' },
  spacer: { height: 6 },
  row: { width: '100%', flexDirection: 'row', marginVertical: 2 },
  column: { width: '50%', alignItems: 'flex-end' },
  separator: { width: '100%', fontSize: 12, fontFamily: 'Courier', textAlign: 'center' },
};
...
class ReciboCarta extends Component {
  ...
  Separator = ({ type = 'dash' }) => (
    <View style={STYLES.spacer}>
      <SPDFText style={STYLES.separator}>
        {type === 'dash' ? '----------------------------------------' : '........................................'}
      </SPDFText>
    </View>
  );
  ...
  Cliente = () => {
    ...
    const fields = [
      ...
      { label: 'Hora:', value: formatTime(data.fecha_on, '12:15 AM') },
    ];
    return (
      <View style={{ width: '100%', alignItems: 'center' }}>
  ...
  handlePress = () => {
    ...
    create(
      <Page style={STYLES.page}>
        {/* {this.HeaderRecibo()} */}
        {/* <this.Separator type="dash" /> */}
        {/* {this.Cliente()} */}
        {/* <this.Separator type="dot" /> */}
        {/* {this.DetalleVenta()} */}
        {/* <this.Separator type="dot" /> */}
        {this.InfoSubtotal()}
        {/* <this.Separator type="dash" /> */}
