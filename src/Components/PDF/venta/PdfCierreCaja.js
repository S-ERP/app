...
export default class PdfCierreCaja {
    ...
    static Header(caja) {
        console.clear();
        console.log("%c" + "entro a header", `color: #cc332e; font-weight: bold;`);
        console.clear();
        console.log("%c" + JSON.stringify(caja, null, 2), "color: #dbd817; font-weight: bold;");
        return (
            <SPDF.View style={{ width: "100%", flexDirection: "row" }}>
                <SPDF.View style={{ flex: 3 }}>
                    <SPDF.Image
                        src={caja?.sucursal?.logo || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfiwNZOWWU_5snwjBWULhLyjSjuVLyJw1SQg&s"}
        ...
        SPDF.create(
            ...
            >
                ...
                <SPDF.View style={{ width: "100%", flexDirection: "row" }}>
                    ...
                    <SPDF.View style={{ width: 80, backgroundColor: "#1ba8d3" }} />

                    <SPDF.View style={{ flex: 3, padding: 10, backgroundColor: "#74d31b" }}>
