...
export default class quizas extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    static Cajero(cajero, data) {
        ...
        return (
            <SPDF.View style={{ width: "100%", flexDirection: "row" }}>
                {/* Columna izquierda: tabla forma de pago */}
                <SPDF.View style={{ flex: 1, borderWidth: 1, padding: 4 }}>
                    ...
                    {tipoPagos.length > 0 ? (
                        <SPDF.View style={{ width: "100%" }}>
                            <SPDF.View style={{ width: "100%", flexDirection: "row", height: 18, backgroundColor: "#D0D0D0" }}>
                                <SPDF.View style={{ width: 20, borderWidth: 1, height: "100%", justifyContent: "center", padding: 2 }}>
                                ...
                                <SPDF.View style={{ flex: 2, borderWidth: 1, height: "100%", justifyContent: "center", padding: 2 }}>
                                    <SPDF.Text style={{ ...textStyle, fontSize: 7, fontWeight: "bold" }}>{"MÉTODO"}</SPDF.Text>
                                </SPDF.View>
                                <SPDF.View style={{ flex: 1, borderWidth: 1, height: "100%", justifyContent: "center", padding: 2 }}>
                        ...
                        <SPDF.Text style={{ ...textStyle, fontSize: 8 }}>{"Sin registros"}</SPDF.Text>
                    )}
                </SPDF.View>

                {/* Columna derecha: cajero + totales */}
                <SPDF.View style={{ flex: 1, borderWidth: 1, padding: 4 }}>
                    <SPDF.View style={{ width: "100%", flexDirection: "row", marginBottom: 4 }}>
                    ...
                    <SPDF.View style={{ width: "100%", flexDirection: "row", marginBottom: 8 }}>
