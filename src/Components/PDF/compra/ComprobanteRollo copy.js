        ...
        try {
            ...
            SPDF.create(
                <SPDF.Page style={{ width: 464, margin: 24, padding: 0, borderWidth: 0 }}>
                    ...
                    {ComprobanteRollo.FooterRecibo(qr, compraVentaData)}
                </SPDF.Page>
            );
        } catch (error) {
                    ...
                    return (
                        <SPDF.View key={i} style={{ width: '100%', marginBottom: 4 }}>
                            ...
                            <SPDF.View style={{ width: '100%', flexDirection: 'row' }}>
                                <SPDF.View style={{ width: '50%' }}>
                                    <SPDF.Text style={{ ...textStyle }}>
                                        cant {cantidad} x {formatCurrency(precio, simbolo)}
                                        {descuentoItem > 0 ? ` (Desc. ${formatCurrency(descuentoItem, simbolo)})` : ''}
                                    </SPDF.Text>
                                </SPDF.View>
                                <SPDF.View style={{ width: '50%', alignItems: 'end' }}>
                                    <SPDF.Text style={{ ...textStyle }}>{formatCurrency(subtotalItem, simbolo)}</SPDF.Text>
                                </SPDF.View>
                            </SPDF.View>
                        </SPDF.View>
                    );
