...
export default class ComprobanteKardexIndividual extends Component {
        ...
        return (
            <SPDF.View style={{ width: "100%" }}>
                ...
                {items.map((item, i) => {
                    ...
                    return (
                        <SPDF.View key={i} style={{ width: "100%", height: 18, flexDirection: "row", backgroundColor: isSaldoAnterior ? "#F5F5F5" : "white" }}>
                            <SPDF.View style={{ width: tableCols.fecha, height: "100%", justifyContent: "center" }}> <SPDF.Text style={{ ...textStyle, width: "100%", fontSize: 7, textAlign: "center" }}>{fecha}</SPDF.Text> </SPDF.View>
                            <SPDF.View style={{ width: tableCols.tipo, height: "100%", justifyContent: "center" }}> <SPDF.Text style={{ ...textStyle, width: "100%", fontSize: 7, textAlign: "center" }}>{item?.tipo || ""}</SPDF.Text> </SPDF.View>
                            <SPDF.View style={{ width: tableCols.nro, height: "100%", justifyContent: "center" }}> <SPDF.Text style={{ ...textStyle, width: "100%", fontSize: 7, textAlign: "center" }}>{item?.key || ""}</SPDF.Text> </SPDF.View>
                            ...
                            <SPDF.View style={{ width: tableCols.debe, height: "100%", justifyContent: "center", paddingHorizontal: 3 }}> <SPDF.Text style={{ ...textStyle, width: "100%", fontSize: 7, textAlign: "right" }}>{debe}</SPDF.Text> </SPDF.View>
                            <SPDF.View style={{ width: tableCols.haber, height: "100%", justifyContent: "center", paddingHorizontal: 3 }}> <SPDF.Text style={{ ...textStyle, width: "100%", fontSize: 7, textAlign: "right" }}>{haber}</SPDF.Text> </SPDF.View>
    ...
    static pagina(data) {
        ...
        return (
            <SPDF.View style={{ width: "100%", marginTop: 6 }}>
                <SPDF.View style={{ width: "100%", height: 1, backgroundColor: "#7F7F7F" }} />
                <SPDF.View style={{ width: "100%", height: 14, flexDirection: "row", alignItems: "center" }}>
                    ...
                    <SPDF.View style={{ minWidth: 34, borderWidth: 1, borderColor: "#7F7F7F", height: 12, justifyContent: "center", alignItems: "center", paddingHorizontal: 4 }}>
                        <SPDF.Text style={{ ...textStyle, fontSize: 7 }}>Pag. 1</SPDF.Text>
                    </SPDF.View>
                </SPDF.View>
                <SPDF.View style={{ width: "100%", height: 1, backgroundColor: "#7F7F7F" }} />
            </SPDF.View>
