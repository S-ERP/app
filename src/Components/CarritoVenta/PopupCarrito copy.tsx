    ...
    render() {
        ...
        return (
            <SView col={"xs-12"} height style={{ backgroundColor: "#252a33" }}>
                ...
                {/* Header */}
                <SView row style={{ backgroundColor: "#2d3440", paddingHorizontal: 20, paddingVertical: 15, alignItems: "center", }}>
                    <SText fontSize={20} bold color={"#ffffff"}>{"🛒 Carrito de Ventas"}</SText>
                    <SView flex />
                    <SView style={{ width: 30, height: 30, borderRadius: 15, backgroundColor: "#ff5252", justifyContent: "center", alignItems: "center", }} onPress={() => SPopup.close("PopupCarrito")} > <SText fontSize={14} bold color={"#ffffff"}>{"✕"}</SText>
                    </SView>
                </SView>

                {/* Selector de moneda */}
                <SView style={{ paddingHorizontal: 15, paddingTop: 12, paddingBottom: 4 }}>
                    <SView style={{
                ...
                {/* Título de sección */}
                <SView row style={{ paddingHorizontal: 15, paddingVertical: 10, alignItems: "center" }}>
                    <SText fontSize={14} color={"#cfd6e0"}>
                        {"Productos ("}{MDL.carrito.carrito_venta.cantidad_items}{")"}
                    </SText>
                    <SView flex />
                    <SText fontSize={14} color={"#cfd6e0"}>
                        {"Subtotal: "}{selectedMoneda?.observacion ?? "Bs"}{" "}{SMath.formatMoney(MDL.carrito.carrito_venta.monto_total)}
                    </SText>
                </SView>
                ...
                <SView style={{
                    ...
                    borderTopWidth: 1,
                    borderTopColor: "#434c5d",
                    paddingHorizontal: 15,
                    paddingVertical: 15,
                }}>
                    <SView row style={{ justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                        <SText fontSize={22} bold color={"#ffffff"}>{"Total"}</SText>
                        <SText fontSize={22} bold color={"#ffffff"}>
                            {selectedMoneda?.observacion ?? "Bs"}{" "}{SMath.formatMoney(MDL.carrito.carrito_venta.monto_total)}
                        </SText>
                    </SView>

                    <SView row style={{ gap: 10 }}>
                        <SView flex style={{
                            ...
                            <SText fontSize={14} bold color={"#ffffff"}>{"Limpiar carrito"}</SText>
                        </SView>
                        ...
                        <SView flex style={{
                            ...
                            <SText fontSize={14} bold color={"#ffffff"}>{"Confirmar venta"}</SText>
                        </SView>
                    </SView>
                </SView>
...
const ItemComp = ({ item, moneda }: { item: any; moneda: any }) => {
    ...
    return (
        <SView style={{
            ...
            <SView row style={{ gap: 12, alignItems: "flex-start" }}>

                {/* Imagen */}
                <SView style={{ position: "relative" }}>
                    <SView style={{ width: 70, height: 70, borderRadius: 8, overflow: "hidden" }}>
                    ...
                    >
                        <SText fontSize={10} bold color={"#ffffff"}>{"✕"}</SText>
                    </SView>
                </SView>

                {/* Info del producto */}
                <SView flex>
                    <SText fontSize={17} bold color={"#ffffff"} style={{ marginBottom: 10 }}>
                    ...
                    <SView row style={{ alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <SView style={{
                            ...
                            {puedeEditarPrecio ? (
                                <SView row center style={{ borderRadius: 4 }}>
                                    <SText fontSize={11} color={"#6cffb4"} style={{ marginRight: 2 }}>
                                    ...
                                    <SView flex>
                                        <SInput2
                                            name="precio"
                                            type="money"
                                            style={{ fontSize: 13, textAlign: "right", paddingRight: 0, color: "#6cffb4" }}
                                ...
                                <SInput2
                                    name="precio"
                                    type="money"
                                    style={{ fontSize: 13, paddingRight: 4, textAlign: "right", color: "#6cffb4" }}
                        ...
                        <SView style={{
                            ...
                            <SInput
                                style={{ fontSize: 13, padding: 0, textAlign: "center", color: "#ffffff", fontWeight: "bold" }}
                                type="money2"
                                icon={<SText fontSize={11} color={"#ffffff"}>{"x"}</SText>}
                        ...
                        {/* Subtotal */}
                        <SText fontSize={17} bold color={"#ffffff"}>
...
const ListaCostos = ({ item, moneda, totalItem }: any) => {
    ...
    return (
        <SView style={{ marginTop: 15 }}>
            <SView row style={{
                borderBottomWidth: 1, borderColor: "#434c5d",
                paddingBottom: 8, marginBottom: 10, alignItems: "center",
            }} onPress={() => setIsOpen(!isOpen)}>
                <SText fontSize={14} bold color={"#ffffff"}>{"Costos"}</SText>
                <SView flex />
                <SText fontSize={11} color={"#8a94a6"}>{" ("}{item.modelo.tipoCostos.length}{")"}</SText>
                <SView style={{ width: 16, height: 16, justifyContent: "center", alignItems: "center", marginLeft: 4 }}>
                    <SIconApp name="Back" fill={"#8a94a6"} width={8}
    ...
    return (
        <SView style={{ marginTop: 15 }}>
            <SView row style={{
                ...
                <SText fontSize={14} bold color={"#ffffff"}>{"Miembros"}</SText>
                <SView flex />
...
const SuscripcionItem = ({ index, item, suscriptor }: any) => {
    ...
    return (
        <SView style={{
            ...
            <SText fontSize={13} bold color={"#ffffff"} style={{ marginBottom: 8 }}>
                {"Miembro "}{index + 1}
            </SText>

            {/* Selector de cliente */}
            <SView style={{ height: 36, backgroundColor: "#1f242d", borderRadius: 8, marginBottom: 8 }}>
                <InputSelector
                    customStyle="erp"
            ...
            <SView row style={{ gap: 8 }}>
                <SView flex style={{ height: 36, backgroundColor: "#1f242d", borderRadius: 8 }}>
                    <SInput
                        style={{ height: 36, fontSize: 12, padding: 0, paddingLeft: 4 }}
                        type="date"
                        icon={<SText width={50} fontSize={10} numberOfLines={1} color={"#8a94a6"}>{"F. Inicio"}</SText>}
                        value={fechaInicio}
                ...
                <SView flex style={{ height: 36, backgroundColor: "#1f242d", borderRadius: 8 }}>
                    <SInput
                        style={{ height: 36, fontSize: 12, padding: 0, paddingLeft: 4 }}
                        type="date"
                        icon={<SText width={40} fontSize={10} numberOfLines={1} color={"#8a94a6"}>{"F. Fin"}</SText>}
                        value={fechaFin}
...
const CostoItem = ({ costo, moneda, totalItem }: any) => {
    ...
    return (
        <SView style={{ marginBottom: 10 }}>
            <SText fontSize={13} color={"#bfc7d4"} style={{ marginBottom: 5 }}>{costo.descripcion}</SText>
            <SView row style={{ gap: 8 }}>
                <SView flex style={{ height: 36, backgroundColor: "#1f242d", borderRadius: 8 }}>
                    <InputSelector
                        customStyle="erp"
                ...
                <SView style={{ width: 80, height: 36, backgroundColor: "#1f242d", borderRadius: 8 }}>
                    <SInput
                        ...
                        type="money2"
                        icon={<SText width={24} fontSize={10} numberOfLines={1} color={"#8a94a6"}>{moneda?.observacion ?? "BS"}</SText>}
                        value={inputValue}
