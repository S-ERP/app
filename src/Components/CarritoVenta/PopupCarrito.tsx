                ...
                <SView flex>
                    ...
                    <SView row style={{ alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                        ...
                        <SView style={{
                            ...
                            backgroundColor: (item?.cantidad || 0) === 0 ? UI.colors.danger + "22" : STheme.color.lightGray + "18",
                            borderWidth: 1,
                            borderColor: (item?.cantidad || 0) === 0 ? UI.colors.danger : STheme.color.lightGray + "40",
                        }}>
                            <SInput
                                style={{ fontSize: UI.font.small, paddingLeft: 0.5, textAlign: "center", color: (item?.cantidad || 0) === 0 ? UI.colors.danger : STheme.color.text, fontWeight: "bold" }}
                                type="money2"
                                icon={<SText fontSize={10} color={(item?.cantidad || 0) === 0 ? UI.colors.danger : STheme.color.text}>{"x"}</SText>}
