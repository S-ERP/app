...
import MDL from "../../MDL";
type SelectorCuentaContableProps = {
...
export default class SelectorCuentaContable extends React.Component<SelectorCuentaContableProps> {
    ...
    async loadData() {
        let data = await MDL.contabilidad.getCuentas();
