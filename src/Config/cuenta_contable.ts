export default {
    // Sucursal
    punto_venta_tipo_pago: { cuenta: "1", label: "Cuentas a las que afecta cada tipo de pago en el punto de venta." },
    // Cajas
    ...
    // Compra
    compra_detalle: { cuenta: "1", label: "Cuenta que rerencia a la referencia del item" },
    // Bancos
    banco_cuenta: { cuenta: "1", label: "[Sin uso] Cuanta que se configura en banco/cuenta/profile." },
