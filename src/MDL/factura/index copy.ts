...
export default class factura extends MDLAbstract<EventListener> {
    ...
    async editarDetalle(factura_key: string, factura_data: any, nuevoDetalle: any[], ambiente: number, state: string) {
        const payload = {
            key: factura_key,
            ambiente: ambiente,
            state: state,
    ...
    editarLeyenda(factura_key: any, factura_data: any, leyenda___: any, ambiente: number, state: string) {
        const ___data = {
            key: factura_key,
            ambiente: ambiente,
            state: state,
