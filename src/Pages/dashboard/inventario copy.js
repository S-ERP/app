...
export default class inventario extends React.Component {
    ...
    loadProductosMayorStock = async (keyEmpresa) => {
        ...
        //     console.log("Productos obtenidos para mayor stock:", productos);
        ...
        //     console.log("Productos con mayor stock:", mayorStock);

        //     if (this._mounted) {
        //         this.setState({ dataProductosMayorStock: mayorStock });
        //     }
        // } catch (e) {
        //     console.error("Error en loadProductosMayorStock:", e);
        //     if (this._mounted) {
        //         this.setState({ dataProductosMayorStock: [] });
        //     }
        // }
        try {
    ...
    loadDashboardData = async () => {
        ...
        try {
            await Promise.all([
                ...
                this.loadProductosMayorStock(empresaSeleccionada.key),
            ]);
        } catch (e) {
                ...
                <ScrollView>
                    <SView col="xs-12" padding={16}>
                        ...
                        <SView col="xs-12" row style={{ marginVertical: 20 }}>
                            ...
                            <SView col="xs-12 md-12" style={{ paddingRight: 10, marginBottom: 20 }}>
                                <SText fontSize={16} bold style={{ marginBottom: 10 }}>
                                    📊 Stock por producto
                                </SText>
                                {loading ? (
