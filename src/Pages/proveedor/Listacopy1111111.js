...
export default class Listacopy1111111 extends Component {
    ...
    mostrarTabla() {
        return (
            ...
            >
                ...
                label="Proveedor" headerStyle={{ paddingLeft: 4 }} width={200} height={60} data={e => e.row?.nombres ?? "Sin Nombre"} customComponent={e => this.renderProveedor(e.row)} />
                <DinamicTable.Col key="tipo_cliente" label="Tipo proveedor" data={e => (e.row.tipo_cliente ?? []).map(a => a.titulo).join(', ')} width={120} height={80}
