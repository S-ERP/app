        ...
        return (
            <>
                <SPage title={''} center onRefresh={(end) => {
                    ...
                    <Container >
                        <Adornos.titulo label={"Por favor, sube una foto de portada para personalizar tu experiencia."} fontSize={18} />
                        ...
                        <SView col={"xs-12"} center>
                            <SForm
                                ...
                                inputs={{
                                    ...
                                    foto: { 
                                        ...
                                        placeholder: "Foto",
                                        isRequired: true,
                                        defaultValue: SSocket.api.empresa + "empresa_portada/" + this.pk,
                                        style: {
                                            height: 159
                                        }
                                    },
                                ...
                                onSubmit={(data) => {
                                    ...
                                    this.form.uploadFiles(
                                        SSocket.api.empresa + "upload/empresa_portada/" + this.pk,
                                        "foto"
                                    );
                            ...
                            <BtnNext onPress={() => { this.form.submit() }}>{"GUARDAR"}</BtnNext>
                            {/* <SHr height={25} />
