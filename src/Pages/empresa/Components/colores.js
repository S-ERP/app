...
class Test extends Component {
    ...
    render() {
        let empresa = Model.empresa.Action.getByKey(this.key_empresa);
        ...
        return (
            <SView>
                ...
                <SInput label={"accent"} defaultValue={STheme.color.accent} ref={ref => this.ref.accent = ref} type='color' />
                <SHr h={20} />
                <SView row>
                    <SView flex />
                    <SText width={100} center card onPress={() => {
                        STheme.color = {
                            ...
                            accent: this.ref.accent.getValue(),
