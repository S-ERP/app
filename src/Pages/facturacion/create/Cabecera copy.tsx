...
export default class Cabecera extends React.Component<CabeceraProps> {
    ...
    shouldComponentUpdate(nextProps: CabeceraProps) {
        // Evitar re-render si sólo cambió el ambiente global pero no los datos que usa este componente
        const curr = this.props;
        const sameTipoDoc = curr.parametricas?.tipoDocumentoIdentidad === nextProps.parametricas?.tipoDocumentoIdentidad;
        const sameCodigoTipo = curr.factura.data.codigoTipoDocumentoIdentidad === nextProps.factura.data.codigoTipoDocumentoIdentidad;
        const sameNumeroDocumento = curr.factura.data.numeroDocumento === nextProps.factura.data.numeroDocumento;
        const sameRazonSocial = curr.factura.data.nombreRazonSocial === nextProps.factura.data.nombreRazonSocial;
        const sameCodigoCliente = curr.factura.data.codigoCliente === nextProps.factura.data.codigoCliente;
        if (sameTipoDoc && sameCodigoTipo && sameNumeroDocumento && sameRazonSocial && sameCodigoCliente) return false;
        return true;
    }
    render() {
