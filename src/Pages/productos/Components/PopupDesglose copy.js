...
export default class PopupDesglose extends Component {
    ...
    static open({ key_modelo }) {
        SPopup.open({
            ...
            content: (
                <SView col={"xs-11  "} backgroundColor={STheme.color.background} style={{
                    borderRadius: 8, maxWidth: 700,

                    height: "95%",
                    maxHeight: 600,

                    // height:sssssssssssss
                    // maxHeight: Math.min(600, Dimensions.get("window").height * 0.9), 
                    // overflow: "hidden"


                }} padding={16} withoutFeedback >
                    <SView col={"xs-12"} height={470} center >
                        {/* <SView col={"xs-12"} style={{ flex: 1, minHeight: 0 }} > */}
