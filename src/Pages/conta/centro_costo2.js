        ...
        return <SPage title={"centro_costo"} >
            ...
            <Container >
                ...
                {this.centro_costo_tipo.map((tipo) => {
                    return <SView col={"xs-12"} padding={0} card style={{
                        marginBottom: 8,
                    }}>
                        <SView col={"xs-12"} row padding={10} style={{
                            ...
                            this.setState({
                                verBloque: this.state.verBloque === tipo.key ? null : tipo.key
                            })
                        }}>
                            {/* <SView width={8} height={8} center style={{ backgroundColor: STheme.color.lightGray, borderRadius: 50, top: 8 }} /> */}
                            <SIconApp width={14} height={14} name={this.state.verBloque === tipo.key ? "vineta2" : "vineta0"} fill={STheme.color.lightGray} style={{ marginTop: 5 }} />
                            <SView width={8} />
                            <SText bold fontSize={18}>{tipo.descripcion}</SText>
                            <SView flex style={{ alignItems: "flex-end" }}>
                                <SView width={60} onPress={() => {
                        ...
                        <SView col={"xs-12"} style={{
                            display: this.state.verBloque === tipo.key ? "flex" : "none"
                        }}>
                            <SView style={{
                                ...
                                {tipo.centros.map(cc => {
                                    return <SView col={"xs-12"} row style={{
                                        ...
                                        <SView width={8} />
                                        <SText col={"xs-10"} flex fontSize={16} onPress={(e) => {
                                            FloatMenu.open({
                                                e: e,
                                                options: [
                                                    {
