  ...
  renderLista() {
    return <SView col={"xs-12"} height={38} border={"transparent"}>
      <SList
        ...
        data={[
          {
            key: "confirmado", label: "confirmado", color: color_activado, icono: "confirmado", onPress: () => {
    ...
    return <SPage   >
      ...
      <SView col={"xs-12"} center row border="transparent" padding={8}>
        ...
        <SView col={"xs-12"} row>
          ...
          <SView col={"xs-12 sm-3.8"} row height={"100%"} >
            <SView col={"xs-12"} row style={{ padding: 8, borderRadius: 16, borderWidth: 2 }} border={STheme.color.card} backgroundColor={STheme.color.card}>
              ...
              <SHr />
              <SView col={"xs-12"} style={{ overflow: "hidden" }} backgroundColor='transparent' >
                <ScrollView color={"blue"}>
