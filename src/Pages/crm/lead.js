...
import { SDate, SHr, SIcon, SNotification, SPage, SText, STheme, SView } from 'servisofts-component';
    ...
    render() {
        return <SPage title={"Tipos leads registrados"}>
            ...
            >
                ...
                <DinamicTable.Col key={"state"} label='Leads' width={100} data={(e) => e.row.state}
                    customComponent={e => {
                ...
                <DinamicTable.Col key={"tipo_movimiento_lead"} label='Info' width={100} data={(e) => e.row.tipo_movimiento_lead?.titulo}
                     />
                <DinamicTable.Col key={"fecha_on"} label='Fecha Registro' width={120} dataType='date'
