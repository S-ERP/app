...
import ListItem from '../restaurante/producto/Components/ListItem';
import CrearNuevo from '../restaurante/producto/Components/CrearNuevo';
        ...
        SPopup.open({
            ...
            content: <CrearNuevo
                ...
                onSelect={(e) => {
                    ...
                    if (e.key == "producto") {
                        SNavigation.navigate("/crm/productoRegistro")
...
export default class producto extends Component {
    ...
    render() {
        ...
        const renderHeader = () => (
            <SView col={"xs-12"}>
                ...
                <SView col={"xs-12"} style={{
                    ...
                    <SView width={140} height={26} center backgroundColor={"white"} style={{
                        borderRadius: 4
                    }} onPress={e => hanlePressCrear(e, this.key_restaurante)}>
                        <SText fontSize={12} color={STheme.color.black}>+ Crear Nuevo</SText>
                    </SView>
                </SView>
                <SHr h={16} />
            </SView>
        ...
        const renderSectionHeader = ({ section }) => {
            ...
            return <SView width={"100%"} row>
                ...
                <SView width={40} height style={{
                    ...
                    {(!this.state.openSections[section.key] && !!section.key_empresa) ? <BtnEditar onPress={() => {
                        SNavigation.navigate("/restaurante/categoria_producto/edit", { key_empresa: this.key_empresa, pk: section.key })
                    }} /> : null}
                </SView>
            </SView>
        }
        ...
        return <SView col={'xs-12'} border={"red"} center>
