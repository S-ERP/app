 ...
 render() {
  return <SPage title={"cliente"}>
   ...
   <DinamicTable
    ...
    <DinamicTable.Col key={"titulo"} label='titulo' width={80} data={(e) => e.row.titulo} />
    <DinamicTable.Col key={"descripcion"} label='descripcion' width={80} data={(e) => e.row.descripcion} />
