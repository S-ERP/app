...
export default class root extends Component {
   ...
   <SHr height={32} /> */}
            ...
            <MenuPages
                ...
                <SHr />
                <MenuButtom label={"Tipos de Movimiento (Lead)"} url={"/crm/tipoMovimientoLead"} icon={<SIconApp name='Ajustes' fill={STheme.color.text} />} />
                <MenuButtom label={"Proyectos"} url={"/crm/proyecto"} icon={<SIcon name='empresa' fill={STheme.color.text} />} />
                <MenuButtom label={"Clientes"} url={"/crm/cliente"} icon={<SIcon name='invite' fill={STheme.color.text} />} />
                <SHr />
                <SText>{"Ventas"}</SText>
                <SHr />
