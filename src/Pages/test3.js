...
export default class index extends React.Component {
    ...
    espacio() {
        return <SPDF.View style={{ width: "100%", height: 15, backgroundColor: "#464646" }} />;
    }

    espaciopequeño() {
        return <SPDF.View style={{ width: "100%", height: 8, backgroundColor: "#474040" }} />;
    }
    ...
    HeaderCierre() {
        ...
        return (
            <SPDF.View style={{ width: "100%", flexDirection: "row", height: 105, backgroundColor: "#f30e0e" }}>
    ...
    Cajero() {
        return (
            <SPDF.View style={{ width: "100%", height: 80, backgroundColor: "#f3ef0e" }}>
    ...
    detalle(movimientos) {
        ...
        return (
            ...
            <SPDF.View style={{ width: "100%", backgroundColor: "#37e615" }}>
                ...
                {movimientos.map((mov, i) => {
                    ...
                    return (
                        ...
                        <SPDF.View key={i} style={{ width: "100%", flexDirection: "row", marginBottom: 8, height: 80, backgroundColor: "#c7099e" }}>
                            <SPDF.View style={{ flex: 1 }}>
    ...
    Resumen() {
        ...
        return (
            ...
            <SPDF.View style={{ width: "100%", flexDirection: "row", height: 200, backgroundColor: "#c7099e" }}>
    ...
    //     const { movimientos } = this.state;
    //     const movimientosPorPagina = 15; // ajusta según tu diseño
    //     const paginas = [];
    ...
    //         // paginas.push(
    //         //     <SPDF.Page style={{ width: 612, height: 791, padding: 20 }} key={i}>
    //         //         {this.HeaderCierre()}
    //         //         {this.Cajero()}
    //         //         {this.detalle(movimientos)}
    //         //         {/* {i + movimientosPorPagina >= movimientos.length && this.Resumen()} */}
    //         //         {/* {i + movimientosPorPagina >= movimientos.length && this.Firmas()} */}
    //         //     </SPDF.Page>
    //         // );
    //     }
