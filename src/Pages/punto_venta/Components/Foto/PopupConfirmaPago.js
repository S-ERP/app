...
export default class PopupConfirmaPago extends Component {
    ...
    form = null;
    variableGlobal = "";
    carritoFormateado = carrito;
    clienteFormateado = carrito;
    vendedorFormateado = {};
    cajaFormateado = {};
    ...
    render() {
        ...
        const { carrito, cliente } = this.props;
        ...
        return (
            <SView col="xs-12">
                ...
                <SView center row style={{ height: 50 }} >
                    <SView center flex style={{ borderColor: STheme.color.card, borderWidth: 2, borderRadius: 4, height: 50 }}
                        onPress={() => {
                    ...
                    <SView center flex style={{ backgroundColor: "#18181b", borderColor: STheme.color.gray, borderWidth: 1, borderRadius: 4, height: 50 }}
                        onPress={() => {
                            ...
                            const carritoFormateado = carrito(item => ({
                                key: item?.key ?? null,
                            ...
                            vendedorFormateado = Model.usuario.Action.getUsuarioLog()
                            ...
                            const datos = this.dataFormateada(carritoFormateado, clienteFormateado, vendedorFormateado, cajaFormateado);
