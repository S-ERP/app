...
export default class Carrito extends Component {
    ...
    addProducto = (producto) => {
        ...
        if (index >= 0) {
            ...
            this.carrito.push({
                ...producto,
                cantidad: 1,
                precio_venta: producto.precio_venta, // Precio base en moneda original (Bs)
    ...
    renderCarrito = () => {
        ...
        const totalConIVA = this.calcularTotalConIVA(subtotalMoneda); // Usar subtotalMoneda para IVA
