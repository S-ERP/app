      ...
      <SView col="xs-12" center>
            ...
            nit: {
              ...
              iconR: (
                <SView
                  ...
                  height={30}
                  center
                  onPress={() => this.handleEditTelefono()}
                >
        ...
        <SView row col={'xs-12'}>
          ...
          <SView
            ...
            onPress={() => SPopup.close('popup_config_horario')}
          >
          ...
          <SView
            ...
            onPress={() => {
              this.props.onReloadCliente?.(this.state.clienteData);
