    ...
    render() {
        ...
        return (
            <SView col={"xs-12"} row style={{ paddingVertical: 4, borderBottomWidth: 0.2, borderBottomColor: STheme.color.card }}>
                <SView col={"xs-1.5    "} row center ba1ckgroundColor='transparent'>
                    {/* <SView col={"xs-2 md-1.3 lg-1.3 "} row center ba1ckgroundColor='transparent'> */}
                ...
                <SView col={"xs-3   "} backgroundColor='pink'>
                ...
                <SView col={"xs-3   "} flex row center backgroundColor='green'>
                    ...
                    <SView center style={{ marginHorizontal: 5 }}>
                        <SInput color={STheme.color.text} editable={false} value={item.cantidad.toString()} border={STheme.color.card} type='number' style={{ width: 35, height: 24, padding: 0, textAlign: "center", fontSize: 12, borderRadius: 4 }} />
                    </SView>
                ...
                <SView col={"xs-1   "} row center backgroundColor='transparent'>
                    {/* <SView col={"xs-1.5 md-1.5 lg-1.5"}  row center backgroundColor='transparent'> */}
                    <SText col={"xs-12"} fontSize={11} bold> Bs {(item.precio_venta * item.cantidad).toFixed(2)}</SText>
                </SView>
                <SView col={"xs-1  "} backgroundColor='transparent' center onPress={onEliminar}>
