...
export default class Categoria extends Component {
    ...
    componentDidMount() {
        ...
        // Suscribirse a cambios globales de moneda
        this.eventoMoneda = () => {
            const moneda = MDL.compra_venta.getMonedaSeleccionada();
            // Clonamos para asegurar nueva referencia y forzar render
                        ...
                        {tipomodelos.map((cat) => (
                            <SView
                                ...
                                style={{
                                    ...
                                    borderRadius: 20,
                                    marginRight: 8,
                                    backgroundColor: selectedCategory === cat.key ? STheme.color.text : STheme.color.card,
                                    opacity: selectedCategory === cat.key ? 1 : 0.6,
                                    borderWidth: 1,
                                    borderColor: selectedCategory === cat.key ? STheme.color.text : STheme.color.lightGray,
                                }}
                            >
