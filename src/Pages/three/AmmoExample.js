...
const ThreeExample = () => {
  ...
  const onContextCreate = (gl) => {
    ...
    const radius = 0.5; // Radio de la cápsula
    const height = 1.5; // Altura de la cápsula (excluyendo los semiesferos)
    ...
    const planeColShape = new ammo.btBoxShape(new ammo.btVector3(planeSize / 2, 0, planeSize / 2));
