...
export default class TablaTransacciones extends Component {
    ...
    mostrarTabla() {
        return (
            <SView col={'xs-12'} style={{ width: 820, alignSelf: 'center' }}>
                <DinamicTable
    ...
    render() {
        ...
        return (
            <SPage title="Kardex Individual" disableScroll>
                ...
                {this.state.saldo > 0 && (
                    <SView col={'xs-12'} style={{ width: 820, alignSelf: 'center', paddingVertical: 12, borderTopWidth: 1, borderColor: STheme.color.lightGray + '66' }}>
                        <SView row col={'xs-12'} style={{ justifyContent: 'flex-end' }}>
                            <SView
                                onPress={() => this.showVentaPopup()}
                                backgroundColor={STheme.color.primary || '#1565c0'}
                                style={{ padding: 12, borderRadius: 8, borderWidth: 1, borderColor: STheme.color.primary || '#1565c0' }}
                                center
                            >
                                <SView row center>
                                    <SIconApp name="pagotarjeta" width={16} height={16} fill={STheme.color.background} />
                                    <SView width={6} />
                                    <SText color={STheme.color.background} bold>Amortizar</SText>
                                </SView>
                            </SView>
                        </SView>
                    </SView>
