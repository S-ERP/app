        ...
        return (
            ...
            >
                ...
                <DinamicTable.Col
                    ...
                    footerComponent={(e) => {
                        ...
                        return <SView style={{ alignItems: "center" }}>
                            ...
                            <SText  > {`${monedaLabel || ""} ${SMath.formatMoney(total || 0)}`} </SText>
                ...
                <DinamicTable.Col
                    ...
                    cellStyle={{ alignItems: "flex-end" }}
                    format={(e) => `${e?.row?.moneda?.observacion || ""} ${SMath.formatMoney(e.data || 0)}`} // Formatea el saldo
                    ...
                    footerComponent={(e) => {
                        ...
                        return (
                            <SView style={{ alignItems: "flex-end", paddingRight: 8 }}>
                                <SText bold>{`${lastRow?.moneda?.observacion || ""} ${SMath.formatMoney(totalSaldo)}`}</SText>
                            </SView>
                        );
                    }}
                />
