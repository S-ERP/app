  ...
  mostrarTabla() {
    return (
                  ...
                  onPress: async () => {
                    try {
                      ...
                      SNotification.send({
                        key: notificationKey,
                        title: "Éxito",
                        body: `Se desactivó la suscripción de ${nombreTurno}`,
                        color: STheme.color.success,
                        time: 3000,
                      });
                    } catch (err) {
      ...
      >
        ...
        <DinamicTable.Col key="key_sucursal" label="Sucursal" width={100} data={(e) => e.row?.key_sucursal ?? ""} customComponent={e => this.renderSucursal(e.row?.sucursal)} />
        ...
        <DinamicTable.Col key={"duracion_"} label='Duración' width={120} data={(e) => e.row?.modelo?.key} wrap textStyle={{ fontWeight: "bold" }} customComponent={e => <SView row style={{ alignItems: "center", }}>
        ...
        <DinamicTable.Col key={"tipo_producto_"} label='Tipo de producto' width={120} data={(e) => e.row?.tipo_producto?.key} wrap textStyle={{ fontWeight: "bold" }} customComponent={e => <SView row style={{ alignItems: "center", }}>
          <SView style={{ width: 25, height: 25, borderRadius: 4, borderWidth: 1, borderColor: STheme.color.card, overflow: "hidden", backgroundColor: STheme.color.card + "66", }}>
