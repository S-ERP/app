    ...
    mostrarTabla() {
        return (
            ...
            >
                ...
                <DinamicTable.Col key="cuotas_cantsidad_pendientes" wrap label="# Cuotas Pendientes" width={60}
                    cellStyle={{ alignItems: 'center', backgroundColor: STheme.color.warning + '33' }}
                    data={e => e.row?.resumen_cuota?.cantidad_pendientes ?? ''} />
                ...
                <DinamicTable.Col key="cuotas_cantidad_mora" wrap label="# Cuotas Mora" width={60}
