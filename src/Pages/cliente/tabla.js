            ...
            <SView col style={{ padding: 4, alignItems: 'flex-end' }}>
                {entries.map(([key_moneda, monto]) => {
                    ...
                    return (<>
                      ...
                      <SText key={key_moneda} style={{ fontSize: 9, color }}>
                        aqui iria la moneda base mas pequeño que se vea bien
                            {fmt.startsWith(sim) ? fmt : `${sim} ${fmt}`}
                        </SText>
                    </>
                    );
    ...
    mostrarTabla() {
        return (
            ...
            >
                ...
                <DinamicTable.Col key="en_mora_col" wrap label="Mora" width={95}
                ...
                <DinamicTable.Col key="mora_base_col" wrap label="Mora Base" width={95}
                ...
                <DinamicTable.Col key="monto_deuda_col_" wrap label="Pendiente" width={95}
                ...
                <DinamicTable.Col key="deuda_base_col__" wrap label="Pendiente Base" width={95}
