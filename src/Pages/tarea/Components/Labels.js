    ...
    getLista() {
        ...
        return <SList2
            ...
            render={(a) => {
                ...
                return <SView
                    // style={{ alignItems: "center", borderRadius: 100, padding: 6, margin: 2, backgroundColor: label?.color + "66" ?? STheme.color.card }}
                    style={{
                    ...
                    <SText fontSize={12} bold>{label?.descripcion}</SText>
                </SView>
            }}
        />
    }
