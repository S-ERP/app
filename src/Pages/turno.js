...
export default class Turno extends Component {
    ...
    bolin() {
        ...
        SPopup.open({
            ...
            content: (
                <SView col={"xs-11 sm-10 md-8"} height={700} backgroundColor={STheme.color.background} style={{ borderRadius: 8, maxWidth: 550 }} padding={16} withoutFeedback>
                    ...
                    <SScrollView2  >
                        {dias.map((dia) => (
                            <SView key={dia} col={"xs-11.7"} style={{ marginBottom: 24 }} border="transparent" center row>
                                ...
                                <SView col={"xs-12"} height={40} style={{ marginBottom: 24 }} backgroundColor={STheme.color.card} row center>
                                    <SView flex backgroundColor="transparent" >
