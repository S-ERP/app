...
class index extends DPA.item {
    ...
    renderState() {
        ...
        return <StateTiqueta label={statesInfo.label} color={statesInfo.color} />
    }
        ...
        return <SView col={"xs-12"} row center>
            <SView width={this.sizeImage} height={this.sizeImage} style={{ padding: 4 }}>
                <SView flex height card style={{
                    ...
                    <SImage src={Model.usuario._get_image_download_path(SSocket.api, this.data.cliente.key_usuario)} />
                </SView>
            </SView>
