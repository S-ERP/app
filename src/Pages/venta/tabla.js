    ...
    mostrarTabla() {
        return (
            ...
            >
                ...
                />
                <DinamicTable.Col key="detalles__lista" label="Suscriptores" width={80} height={60} headerStyle={{ paddingLeft: 4 }} data={(e) => (e.row?.detalles || []).flatMap(detalle => detalle.suscriptores || []).map(s => s.key_cliente).join(", ")}
                    customComponent={(e) => {
