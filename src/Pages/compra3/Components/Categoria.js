    ...
    renderCategorias() {
        ...
        return (
            <SView col={"xs-12 md-12"} row center style={{ paddingHorizontal: 8, paddingVertical: 8 }}>
                {/* <SView col={"xs-12 md-12"} backgroundColor={STheme.color.background} row center style={{ paddingHorizontal: 8, paddingVertical: 8 }}> */}
                <SView col={"xs-12"} row>
                        ...
                        <SView col={"xs-12 md-5 lg-2.5"} row center>
                            <SView col={"xs-12"} row center height={32}>
                                <SInput
                                    ...
                                    type="checkBox"
                                    labelStyle={{ left: 14, top: -4 }}
                                    value={this.props.conServicio}
                                    onChangeText={(text) => this.props.onChangeConServicio?.(text)}
                                />
                            </SView>
                        </SView>
