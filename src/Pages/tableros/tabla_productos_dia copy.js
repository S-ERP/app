                                    ...
                                    >
                                        ...
                                        {...dias.flatMap(d => [
                                            <DinamicTable.Col
                                                ...
                                                customComponent={(e) => {
                                                    const diaObj = e.row.dias.find(x => x.dia === d.dia);
                                                    const cantidad_v = diaObj?.ventas_cantidad || 0;
                                                    return (
                                                        <SView style={{ alignItems: "center" }}>
                                            ...
                                            <DinamicTable.Col
                                                ...
                                                data={e => {
                                                    const diaObj = e.row.dias.find(x => x.dia === d.dia);
                                                    return diaObj ? diaObj.compras_cantidad : 0;
                                                }}
                                                customComponent={(e) => {
                                                    const diaObj = e.row.dias.find(x => x.dia === d.dia);
                                                    const cantidad_c = diaObj?.compras_cantidad || 0;
                                                    return (
                                                        <SView style={{ alignItems: "center" }}>
                                                    ...
                                                    const totalCantidad_compras = dataVentasPorDia.reduce((acc, row) => {
                                                        const diaObj = row.dias.find(x => x.dia === d.dia);
                                                        return acc + (diaObj?.compras_cantidad || 0);
                                                    }, 0);
                                                    return (
                                                        <SView style={{ alignItems: "center" }}>
                                        ...
                                        <DinamicTable.Col
                                            ...
                                            customComponent={(e) => {
                                                ...
                                                const totalCantidad_compras = e.row.dias.reduce((acc, d) => acc + (d.compras_cantidad || 0), 0);
                                                    ...
                                                    <SView style={{ alignItems: "center" }}>
                                                        {totalCantidad > 0 || totalMonto > 0 ? (
                                                            <>
                                                                ...
                                                                <SText fontSize={10}>{`${totalCantidad_compras} compras`}</SText>
