...
const AgregarContacto = ({ estado, clientes, stage, onAddCliente, onNuevoCliente }) => {
            ...
            <SView row col={"xs-12"} style={{
                ...
                {verBoton && (<SView col={"xs-12"} style={{ alignItems: "flex-end" }}>
                    ...
                    <SView height={20} width={100} center style={{
                        ...
                        console.log("Proveedor seleccionado para agregar:", proveedor);
                        console.log("Stage al agregar cliente:", stage);
                        if (proveedor) {
                            MDL.crm.tipoCliente.addToCliente({
