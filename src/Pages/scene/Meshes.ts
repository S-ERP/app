...
export class MeshItem {
    ...
    handleOnLoad(gltf: GLTF) {
        ...
        this.group = object;
        this.gltf = gltf;
        object.name = this.props.data.key;
        ...
        let grouptype = this.props.group.getObjectByName(this.props.data.descripcion)
        if (!grouptype) {
            grouptype = new THREE.Group();
            grouptype.name = this.props.data.descripcion;
            this.props.group.add(grouptype)
        }
        grouptype.add(object)
    ...
    transform: any;
    createBody(child: THREE.Object3D, parent: THREE.Group) {
        ...
        this.body.userData = {};
        this.body.name = parent.name + "." + child.name
        this.body.id = child.id
        // this.body.userData = parent.name + "." + child.name
        ...
        // Configurar el cubo como cinemático
        // this.body.setCollisionFlags(this.body.getCollisionFlags() | 2); // 2 = Kinematic
        // Asegurarse de que el cubo no esté afectado por la física normal
        // this.body.setActivationState(4); // 4 = Disable deactivation
        // this.body.setCcdMotionThreshold(0.1);
        // this.body.setCcdSweptSphereRadius(this.radius * 0.8);
