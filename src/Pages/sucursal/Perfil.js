...
import { SButtom, SForm, SHr, SIcon, SInput, SNotification, SPopup, SText, STheme, SUuid, SView } from 'servisofts-component';
import MDL from '../../MDL';
...
export default class Perfil extends Component {
    ...
    componentDidMount() {
        ...
        if (!this.props.key_sucursal) return;

        MDL.empresa.getAllSucursales().then((sucs) => {
            this.ProveedorItem = sucs.find(e => e.key == this.props.key_sucursal);

            // this.ProveedorItem = sucs.find((e: any) => e.key == this.props.key_sucursal);
            this.forceUpdate();
