                ...
                <FlatList
                    ...
                    renderItem={opcionSeleccionada === "movimientos"
                        ? ({ item, index }) => {
                            ...
                            const esReversionAmortizacion = REVERSION_AMORTIZACION_TIPOS.includes(item.tipo);
                            const anulado = esAmortizacion
                                ? this.state.movimientos.some(m => REVERSION_AMORTIZACION_TIPOS.includes(m.tipo) && m.key_caja_detalle_original === item.key)
                                : esReversionAmortizacion
                                    ? true
