...
export default class root extends Component {
    ...
    renderMunuItem({ onPress, label, icon, color }) {
        return <SView width={100} card padding={8} onPress={onPress} center row>
        ...
        return <SView col={"xs-12"} center>
            <SView col={"xs-12 sm-10 md-9 lg-7 xl-6 xxl-5"} center >
                ...
                <ScrollView horizontal style={{
                    ...
                    {/* <SView row col={"xs-12"}> */}
                        {this.renderMunuItem({ label: "Volver", icon: "Arrow", color: STheme.color.danger, onPress: () => SNavigation.navigate("/root") })}
                        <SView width={8} />
                        ...
                        <SView width={8} />
                        {this.renderMunuItem({ label: "Ajustes", icon: "Ajustes", onPress: () => SNavigation.navigate("/menu") })}
